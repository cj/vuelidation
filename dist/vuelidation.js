...
(function (global, factory) {
	...
	(factory((global.Vuelidation = global.Vuelidation || {})));
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === undefined ||
      (eq_1(objValue, objectProto$11[key]) && !hasOwnProperty$9.call(object, key))) {
    return srcValue;
  }
  return objValue;
}
...
function valid (modelName) {
  ...
  var validations$$1 = modelName ? this.$options.vuelidation.model[modelName] : this.$options.vuelidation.model;

  Object.entries(validations$$1).forEach(function (ref) {
    var model = ref[0];
    var modelValidations = ref[1];

    validate.call(this$1, model, this$1[model], modelValidations);
  });
  ...
  Vue.mixin({
    created: function created () {
      ...
      if (vuelidation && vuelidation.model) {
        Object.entries(vuelidation.model).forEach(function (ref) {
          var model = ref[0];
          var modelValidations = ref[1];

          this$1.$watch(model, function (value) {
            validate.call(this$1, model, value, modelValidations);
          });
        });
      }
    },
    ...
    computed: {
      $vuelidation: function $vuelidation () {
        ...
        return {
          ...
          errors: function () {
            return this$1.vuelidationErrors
          },
